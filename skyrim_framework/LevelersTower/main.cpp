...
//#include "MySkseExtension/MyPapyrusPotion.h"
//#include "MySkseExtension/MyPapyrusObjectReference.h"
//#include "MySkseExtension/MyPapyrusActor.h"
#include "MySkseExtension/MyPapyrusForm.h"
#include "LevelersTower.h"
#include "skse/PluginAPI.h"
#include "skse/skse_version.h"
#include "skse/PapyrusVM.h"

//IDebugLog	gLog("LevelersTower.log");
...
bool RegisterPapyrus(VMClassRegistry* registry)
{
	...
	//papyrusPotion::MyRegisterFuncs(registry);
	//papyrusObjectReference::MyRegisterFuncs(registry);
...
{
	//_MESSAGE("myskseplugin");

	// populate info structure
	info->infoVersion =	PluginInfo::kInfoVersion;
	info->name =		"LevelersTowerPlugin";
	info->version =		1;
...
bool SKSEPlugin_Load(const SKSEInterface * skse)
{
	...
	//g_scaleform->Register("myskseplugin", RegisterScaleform);

	// register papyrus callbacks
